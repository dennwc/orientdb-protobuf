...
@Test
public class PDocumentSchemalessBinarySerializationTest {
  ...
  public void testSimpleSerialization() {
    ...
    byte[] res = PDocumentSerializer.serialize(document);
    ODocument extr = (ODocument) PDocumentSerializer.deserialize(res);
